...
class MyFrame(Frame):
    def button_action(self): #Insert all the default values here
        #Required arguments
        try:
            self.PDB = self.PDB_file
            self.Gene = self.Gene_file
            self.M8 = self.M8_file
            self.Full_PDB_sequence = self.Full_PDB_sequence_file
        except:
            self.PDB = []
            self.Gene = []
            self.M8 = []
        ...
        try:
            ...
            self.Format='fasta'
        try:
            self.Domains_Path = self.Domains_file
        except:
            self.Domains_Path = []
        try:
            self.Domains_list = self.Domains_file_list
        except:
            self.Domains_list =[]
        try:
            self.domains = self.domain_entry.get()
    ...
    def __init__(self,den):
        ...
        self.chains_label.grid(row=0, column=1)
        self.chains_entry.grid(row=0, column=2)
        self.button2.grid(row=1, column=0)
        self.sequence_label.grid(row=1, column=1)
        self.sequence_entry.grid(row=1, column=2)
        self.button3.grid(row=2, column=0)
        self.probability_label.grid(row=2, column=1)
        self.probability_entry.grid(row=2, column=2)
        self.button4.grid(row=3, column=0)
        self.print_label.grid(row=3, column=1)
        self.print_entry.grid(row=3, column=2)
        self.button5.grid(row=4, column=0)
        self.domain_label.grid(row=4, column=1)
        self.domain_entry.grid(row=4, column=2)
        self.button6.grid(row=5, column=0)
        self.format_label.grid(row=5, column=1)
        self.format_entry.grid(row=5, column=2)
        self.missing_label.grid(row=6,column=1)
        self.missing_entry.grid(row=6,column=2)
